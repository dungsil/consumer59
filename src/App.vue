...
const data = reactive<Record<number, string>>({
  ...
  42: "파렴치한 SPC파리바게뜨 NO! 눈물로 만든 빵 안 먹어!!",
  43: "SPC파리바게뜨와 헤어지자!",
  ...
  54: "제빵사들의 눈물젖은 파리바게뜨빵, 사지도 먹지도 맙시다!",
  55: "점심시간도, 휴가도 보장하지 않는 SPC삼립, 파리바게뜨, 던킨도너츠, 배스킨라빈스 안먹어 !",
  56: "SPC그룹이 인권을 보장하고, 노동법을 준수할 때까지 저는 제품을 사지 않겠습니다.",
  57: "#던킨 #배라 #삼립 안사요.",
